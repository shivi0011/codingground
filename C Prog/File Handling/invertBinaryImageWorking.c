                 ...
                 if(!feof(fp1))
                 {
                    if(i>170)
                    {
                         if(a == 0)
                         {
                            ...
                            //unsigned char g = 0xff;    also working but it wont work for all in case of other colors
                            unsigned char g = 0xff-a;
                            fputc(g,fp2);
                            continue;
                         }

                         fputc(0xff-a,fp2);        //value should be in hexadecimal... 0 is same as 0x00
                         continue;
                    }
